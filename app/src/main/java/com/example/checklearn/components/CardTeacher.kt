...
fun CardTeacher(
    ...
    Column(
        ...
        val grade = buildAnnotatedString {
            ...
            withStyle(
                style = SpanStyle(
                    color = getColorByGrade(studentResult.testResult.grade),
                    fontWeight = FontWeight.Bold
                )
            ) {
                append("${studentResult.testResult.grade}")
            }
        }
        Text(
            text = grade,
        ...
        Row(
            ...
            Text(
                text = studentResult.testResult.date,
                fontSize = 14.sp,
                color = Gray3
            )
            IconButton(
                ...
                Icon(painter = painterResource(R.drawable.arrow_down),contentDescription = null,tint = Color.Black)
            }
        }
        AnimatedVisibility(
            isExpended.value,
            ...
            Column(
                ...
                Text(
                    text = "${studentResult.testResult.correctAnswers}/${studentResult.testResult.totalQuestions}",
                    color = Color.Black,
                    fontSize = 14.sp
                )
                studentResult.testResult.questions.forEach {
                    Column(
